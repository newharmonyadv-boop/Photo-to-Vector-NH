...
function createApp() {
  ...
  elements.engineMode.value = "legacy";
  elements.productionColors.value = "12";
  elements.productionSmoothing.value = "2";
  elements.minimumArea.value = "12";
  elements.holeFilling.value = "1";
  elements.shadowCorrection.value = "55";
  elements.preserveDots.checked = true;
...
test("accepts a PNG and shows its original preview", () => {
  ...
  assert.deepEqual(app.elements.originalPreview.children, [app.elements.originalImage]);
